...
import { BarChart3, MessageCircle, Video, Star } from "lucide-react";
  ...
  return (
    <main className="min-h-screen max-w-5xl mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          { icon: BarChart3, label: "Dashboard", desc: "Fan metrics & engagement" },
          { icon: MessageCircle, label: "Fan Messages", desc: "Connect with followers" },
          { icon: Video, label: "Content", desc: "Videos, polls & posts" },
          { icon: Star, label: "Monetization", desc: "Premium fans & sponsors" },
