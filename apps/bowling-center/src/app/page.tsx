...
import { LayoutDashboard, Trophy, ShoppingBag, MapPin } from "lucide-react";
  ...
  return (
    <main className="min-h-screen max-w-5xl mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          { icon: LayoutDashboard, label: "Dashboard", desc: "Members & geo-analytics" },
          { icon: Trophy, label: "Tournaments", desc: "Host & manage events" },
          { icon: ShoppingBag, label: "Pro Shop", desc: "Product inventory" },
          { icon: MapPin, label: "Leagues", desc: "Standings & schedules" },
