...
import { Trophy, CalendarDays, Users, ClipboardList } from "lucide-react";
  ...
  return (
    <main className="min-h-screen max-w-5xl mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          { icon: Trophy, label: "Tournaments", desc: "Create & manage" },
          { icon: CalendarDays, label: "Events Calendar", desc: "Schedule & track" },
          { icon: Users, label: "Registrations", desc: "Players & teams" },
          { icon: ClipboardList, label: "Leagues", desc: "Standings & scores" },
